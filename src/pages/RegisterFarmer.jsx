...
function RegisterFarmer() {
  ...
  const handleSubmit = (e) => {
    ...
    // Store details for Login pre-population
          ...
          <div className="reg-floating-card">
            {!submitted ? (
              <form onSubmit={handleSubmit} className="reg-card-form">
                ...
                {/* Inline Login Redirection */}
                <div className="card-login-row">
                  Already have an account? <a href="/login">Login</a>
                </div>

                {/* Integrated Call Help Box */}
                <div className="help-assisted-box">
                  <span className="help-icon">📞</span>
                  <div className="help-desc">
                    <strong>Need help registering? Call our toll-free center.</strong>
                    <small>Dial 1800-120-7890 for assisted registration support.</small>
                  </div>
                </div>
              </form>
            ) : (
              ...
              <div className="success-registered-pane">
                ...
                <p style={{ fontSize: '11px', color: '#557262', margin: '4px 0' }}>
